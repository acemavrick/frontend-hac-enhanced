...
<div class="flex min-h-screen items-center justify-center px-4">
	<div class="w-full max-w-md">
		<div class="mb-8 text-center">
			<h1 class="text-3xl font-bold tracking-tight text-text-primary">Reset Password</h1>
			<p class="mt-2 text-sm text-text-muted">Use your master password to reset</p>
		</div>
		...
		<p class="mt-4 text-center text-sm text-text-muted">
			<a href="/login" class="font-medium text-brand-400 hover:text-brand-300">Back to sign in</a>
		</p>
	</div>
</div>
